        ...
        <div class="row">
            <div class="col-md-10 col-md-offset-1" style="text-align: right;">
                <div class="box box-default">
                    ...
                    <form style="margin:10px 5px 5px 5px;padding: 2px" id="form-change-password" role="form" method="POST" action="{{ URL::to(url('/reset_password') )}}"
                          novalidate class="form-horizontal">

                        {{ csrf_field() }}

                        <input name="user_id" type="hidden" value="{{$ustudent->user_id}}">
                        <input name="national_code" type="hidden" value="{{$ustudent->national_code}}">
